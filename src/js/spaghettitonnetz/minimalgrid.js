...
class MinimalGrid {
    ...
    drawBuffer() {
        this.gb.canvas.width = 1200*scl;
        this.gb.canvas.height = 619*scl;
        this.gb.clearRect(0,0,this.gb.canvas.width,this.gb.canvas.height);
        //set font
      
        this.gb.lineWidth = scl * 3;
